...
class DashboardController extends Controller
{
    ...
    function show(){ 
        ...
        $orders =  DB::select(
            "SELECT b.price,SUM(b.qty) as qty,a.* from orders a inner join order_details b on a.id = b.order_id GROUP BY (a.id) ORDER BY a.created_at DESC LIMIT $num_per_page OFFSET {$offset}"
        ); 
