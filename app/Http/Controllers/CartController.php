...
class CartController extends Controller
{
    ...
    function add(Request $request, $id){
        ...
        $total_qty = 0;
        $product_info = DB::select("SELECT * FROM `product_attribute` INNER JOIN products on product_attribute.product_id = products.id  where product_attribute.product_id = $id and product_attribute.color_id =$color and product_attribute.size_id = $size GROUP by product_attribute.product_id");
