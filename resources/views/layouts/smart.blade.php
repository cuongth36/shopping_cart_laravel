                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-12 col-md-3 custom-col-pt col-xl-3 t-center-laptop">
                      ...
                      <ul class="f-content-list-item">
                        <li class="f-content-items"><a class="fc-item fc-item-color-st1" href="#">Giới thiệu cửa hàng</a></li>
                        <li class="f-content-items"><a class="fc-item fc-item-color-st1" href="#">Liên hệ với chúng tôi</a></li>
                      </ul>
                    </div>
                    <div class="col-12 col-md-3 custom-col-pt col-xl-3 t-center-laptop">
                      ...
                      <ul class="f-content-list-item">
                        <li class="f-content-items"><a class="fc-item fc-item-color-st1" href="#">Chính sách mua hàng</a></li>
                        <li class="f-content-items"><a class="fc-item fc-item-color-st1" href="#">Chính sánh bảo hành</a></li>
                      </ul>
                    </div>
                    <div class="col-12 col-md-3 custom-col-pt col-xl-3 t-center-laptop">
              ...
              <div class="row">
                <div class="col-md-6 cl-md-ipad-12 col-lg-6 col-xl-6 order-mobile-cp">
                  <div class="info-copyright">
                    <span>Copyright © 2019 by Smart All Rights Reserved</span>
                  </div>
                </div>
