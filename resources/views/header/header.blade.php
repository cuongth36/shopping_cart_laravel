    ...
    <header>
      ...
      <div class="hamadryad-minicart">
        <div class="hamadryad-minicart-content">
          ...
          <span class="hamadryad-minicart-number">{{Cart::count()}} sản phẩm</span>
                      ...
                      <li class="product-cart">
                        ...
                        <div class="product-detail">
                          ...
                          <div class="product-detail-info">
                            <div class="product-quality">Số lượng : {{$item->qty}}</div>
                            <div class="product-cost">{{number_format($item->total, 0 , ' ', '.')}}</div>
                          </div>
                        </div>
