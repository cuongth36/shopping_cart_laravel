...
//Customer 
Route::get('register-customer', 'CustomerController@register')->name('customer.register');
Route::get('sign-in', 'CustomerController@login')->name('customer.login');
Route::get('sign-in-customer', 'CustomerController@loginCustomer')->name('sign-in');
...
Route::get('san-pham/color/{slug}{extension}', 'ProductController@getColorId')->name('product.change');
...
// Route::get('tin-tuc/{slug?}{extension}', 'PostController@postOfCategory')->name('post.list.category');
...
Route::middleware('auth')->group(function(){
    ...
    Route::prefix('admin')->group(function(){
        ...
        Route::prefix('user')->group(function(){
            ...
            Route::get('edit/{id}', 'Admin\UserController@edit')->name('user.edit')->middleware('can:user-edit');
        ...
        Route::prefix('product')->group(function(){
            ...
            // product
            Route::get('list', 'Admin\ProductController@list')->name('product.list')->middleware('can:product-list');
            ...
            Route::get('color/pagination', 'Admin\ColorController@pagination')->name('color.pagination');
             ...
             // size product
             Route::get('size/list', 'Admin\SizeController@list')->name('size.list');
             ...
             Route::get('size/delete/{id}', 'Admin\SizeController@delete')->name('size.delete');
             Route::post('size/action', 'Admin\SizeController@action')->name('size.action');
        ...
        Route::prefix('order')->group(function(){
            ...
            // Route::get('revenue/show','Admin\InventoryController@getAllMonth');
        });
